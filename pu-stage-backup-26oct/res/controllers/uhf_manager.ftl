...
<#if !user.anonymous>
    ...
    <#else>
        ...
        <#else>
            ...
            <validModes>flow_url,powerapps_url,get_flow_head,get_flow_header,get_flow_footer,get_powerapps_head,get_powerapps_header,get_powerapps_footer,update_flow_head,update_flow_header,update_flow_footer,update_powerapps_head,update_powerapps_header,update_powerapps_footer</validModes>
        </#if>
    </#if> <#-- start (mode) -->
