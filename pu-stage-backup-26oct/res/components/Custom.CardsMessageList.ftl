...
<!-- Clean parameters -->
<#if sourceBoard=="jgvjg48436"> <!-- for preview only -->
    <#assign sourceBoard="PowerAppsForum1" />
</#if>
            ...
            <#if post??>
                ...
                <div class="lia-messages-message-card">
                    <div class="lia-messages-message-card-container">
                        <a href="${view_href}">
                            <div class="lia-messages-message-card-image-wrapper" text="${viewReportText}">
                                <#if post_image?has_content>
                                    <img src="${post_image}" class="lia-card-image" title="${post.subject}" alt="${post.subject}" height="173" width="300" />
                                <#else>
