...
<#-- <#include "uhf_config.ftl"/>
 ${settings.name.get(uhfKeys("flow_head"))?replace("scode","script")} 
<script>
 // Add social banner
...
window.SocialBannerHelper = {
                ...
                var followPlatforms = [
		            { id: "twitter", url: "https://twitter.com/microsoftflow", imagePath: window.SocialBannerHelper["twitter-path"], accessibilityText: window.SocialBannerHelper["follow-twitter"] },
		            { id: "rss", url: "https://flow.microsoft.com/blog/feed/", imagePath: window.SocialBannerHelper["rss-path"], accessibilityText: window.SocialBannerHelper["follow-rss"], class: "uhf-rss" },
		            { id: "youtube", url: "https://go.microsoft.com/fwlink/?LinkID=786359&clcid=0x409 ", imagePath: window.SocialBannerHelper["youtube-path"], accessibilityText: window.SocialBannerHelper["follow-youtube"], class: "uhf-youtube" }, ];
</script>
<@uhfClienSideJS/> -->
