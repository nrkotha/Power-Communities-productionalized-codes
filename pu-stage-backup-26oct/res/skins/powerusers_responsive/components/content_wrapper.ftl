...
<div class="papps-custom-banner lia-content" role="header">
    <div class="container">
        <h2 class="welcome-title">Welcome to the Power platform community</h2>
    </div>
</div>
<div class="login-custom-banner lia-content">
    <div class="container">
        <h2 class="welcome-title">Get data from SharePoint Online Lists: Lookup columns threshold</h2>
    </div>
</div>
<#--</#if>-->


<@liaBody /><link type="text/css" rel="stylesheet" href="/html/assets/jquery.qtip.min.css" />
