...
<#-- Displays Custom video URL box -->
    ...
    <div class="lia-form-row lia-form-microsoftmsg-report-url-entry" style="display: none;">
        <div class="lia-form-label-wrapper">
            <label for="microsoftvideo_report_url" class="lia-form-label">Enter a video URL</label>
            <#if optional!="true">
            ...
            <div class="lia-quilt-column lia-quilt-column-24 lia-quilt-column-single">
                <div class="lia-quilt-column-alley lia-quilt-column-alley-single">
                    <div class="lia-form-microsoftmsg-report-url-input">
                        <input class="lia-form-microsoftmsg-report-url-input lia-form-type-text lia-form-input-vertical" id="microsoftvideo_report_url" name="microsoftvideo_report_url" value="" placeholder="YouTube Video URL" type="text" optional="${optional}">
                    </div>
                </div>
            </div>
        </div>
...
<#-- Attaches the Video URL to body in hidden mode. -->
            ...
            var additionalData = '<span class="videoUrl hidden">'+videoURLID+'</span>';
