        ...
        <div class="lia-message-custom-heading">
            ...
            <div class="lia-message-metrics">
                ...
                <div class="lia-social-share linkList linkList-horizontal">
                    ...
                    <a href="http://twitter.com/share?text=Check out this video: ${page.context.message.subject} %23PowerBI %23PowerPointGallery&url=${page.context.message.webUi.url}" class="social-share social-twitter">
            ...
            (function ($) {
				...
				try{
					$.each($('.message-uid-${tid} #attachments .lia-link-navigation'),function(index,value){	
						...
						if(value.innerText.indexOf('.ppt') >= 0){
