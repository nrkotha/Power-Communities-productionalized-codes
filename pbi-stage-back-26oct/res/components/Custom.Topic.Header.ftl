        ...
        <div class="lia-message-custom-heading">
            ...
            <div class="lia-message-author lia-component-author">
                <div class="lia-message-author-avatar">
                    <div class="UserAvatar lia-user-avatar lia-component-common-widget-user-avatar">
                        <a class="UserAvatar lia-link-navigation" href="${message.author.view_href}">
            ...
            <div class="lia-message-metrics">
                ...
                <div class="lia-social-share linkList linkList-horizontal">
                    ...
                    <a href="http://twitter.com/share?text=Check out this data story: ${page.context.message.subject} %23PowerBI %23DataStoriesGallery&url=${page.context.message.webUi.url}" class="social-share social-twitter">
...
<#-- Video Gallery Topic Page CSS -->

#lia-body .lia-content .lia-quilt-forum-topic-page-video-gallery .first-message .lia-quilt-column-main-left {
                display: none;
            }

            #lia-body .lia-content .lia-quilt-forum-topic-page-video-gallery .first-message .lia-message-heading {
                display: none;
            }

            #lia-body .lia-content .lia-quilt-forum-topic-page-video-gallery .first-message .lia-message-dates {
                display: none;
            }

            <#if post_replies gt 0>
            
            #lia-body .lia-content .lia-quilt-forum-topic-page-video-gallery .first-message .lia-message-view {
                padding-bottom: 35px;
            }

            #lia-body .lia-content .lia-quilt-forum-topic-page-video-gallery .first-message:after {
                content: "Comments";
                padding: 7px 7px 7px 10px;
                background-color: #eaeaea;
                display: block;
