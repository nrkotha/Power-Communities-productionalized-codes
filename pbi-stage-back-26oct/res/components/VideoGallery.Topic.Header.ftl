        ...
        <div class="lia-message-custom-heading">
            ...
            <div class="lia-message-metrics">
                ...
                <div class="lia-social-share linkList linkList-horizontal">
                    ...
                    <a href="http://twitter.com/share?text=Check out this video: ${page.context.message.subject} %23PowerBI %23VideoGallery&url=${page.context.message.webUi.url}" class="social-share social-twitter">
