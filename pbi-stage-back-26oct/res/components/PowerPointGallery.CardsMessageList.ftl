<#--
    ...
    PowerPoint Gallery: A Gallery where users can post PowerPoint. 
    iTrack : MC – 10. 
...
<#--
    ...
    Description:
        ...
        This component is created to display grid structure of all the PPTs posted to the board. 

    Activities:
        1. Displays grid structure of all PPTS posted to the board.
        2. Has the functionality to filter the PPTS through Labels.
        3. Has the functionality to filter the PPTS through custom filters Featured, Top Kudos and Recently posted.          
...
<#if sourceBoard=="oxcrx34285"> <!-- for preview only -->
    <#assign sourceBoard="PowerPointGallery" />
</#if>
            ...
            <#if post??>
                ...
                <div class="lia-messages-message-card">
                    <div class="lia-messages-message-card-container">
                        <a href="${view_href}">
                            <div class="lia-messages-message-card-image-wrapper" text="View PowerPoint">
...
(function ($) {
    ...
    /** MC-404 updating button text **/
    /* $('.lia-menu-bar .lia-button-primary span').html('Submit a PowerPoint'); */
    $('.lia-menu-bar .lia-button-primary span').html('Submit a Consulting Service');
